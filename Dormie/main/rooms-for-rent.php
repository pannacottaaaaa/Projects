<?php
	...
	function getAllDorms(){
        ...
        {
			if($record['is_published'] == true && $record['is_verified'] == true) {
				...
				<div class='dorm-card'>
				<div class='dorm-pic'>";
				if (isset($photo_record['photo_path'])) {
					$photo = $photo_record['photo_path'];
				} else {
					$photo = "error.jpg";
				}
				echo "<img src='images/{$photo}' alt='Dorm picture' style='width: 100%; height: 100%;'>";
				echo "</div>
				<div class='dorm-name'>
	...
	function searchDormLoc() {
		...
		or region LIKE '%$searchDorm%'") or die("Could not search! ");
...
<body>
	<div id="maingrid">
		...
		<div id="content">
			...
			<div class="map-container"> <!-- nakagitna  po sana itong map -->
				<h2>Search as you move!</h2>
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3861.5718177726367!2d121.01283251483976!3d14.566461389824202!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397c9080e6f2abd%3A0x1d5b9be15aad02!2sMap%C3%BAa%20University%20Makati!5e0!3m2!1sen!2sph!4v1672148994522!5m2!1sen!2sph"
				id="gmap" width="1265" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
